...
\centering
	...
	\centering
	\includegraphics[height=2in]{../csv_output/muon_prob.png}
	\label{fig:muonprob}
	\caption{Muon Prob}
	\end{subfigure}
	...
	\begin{subfigure}[t]{.5\textwidth}
	\centering
	\includegraphics[height=2in]{../csv_output/pi_prob.png}
	\label{fig:piprob}
	\caption{Pion Prob}
	\end{subfigure}
	\quad
	...
	\begin{subfigure}[t]{.5\textwidth}
	\centering
	\includegraphics[height=2in]{../csv_output/eminus_prob.png}
	...
	\begin{subfigure}[t]{.5\textwidth}
	\centering
	\includegraphics[height=2in]{../csv_output/gamma_prob.png}
	\label{fig:gammaprob}
	\caption{Gamma Prob}
	\end{subfigure}
\caption{placeholder}
