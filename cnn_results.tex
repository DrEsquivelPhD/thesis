...
\centering
	...
	\includegraphics[width=\textwidth]{figs/train_confusion-9-14-16.png}
	\label{fig:confusion}
	\caption{Confusion Matrix showing Accuracy of CNN using training data}
	\end{subfigure}
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/val_confusion_9-14-16.png}
	...
	\end{subfigure}
\caption{\ref{fig:confusion} \ref{fig:confusion_test} Description of confusion matrix varables: False pion rate = $false \pi/ total \pi$ True pion rate = $true \pi/total \pi$ Accuracy = $(true \pi rate + true \mu rate)/2$ Pion prediction value = $true \pi/(true \pi + false \pi)$ Muon prediction value = $true \mu/(true \mu + false \mu)$ \ref{fig:prob_plot} The probability plot includes muons and pions that are classified as primary particles.}
\label{fig:CNN_train}
\end{figure}

Figures \ref{fig:confusion}, \ref{fig:confusion_test} and \ref{fig:prob_plot} shows a breakdown of $\mu/\pi$ separation for CNN10000. It also shows the network is not being overtrained due to the Accuracy of both the training and testing datasets being within .01\% of eachother. The CNN is doing a very good job of classifying true muons as muons, and our loss increase from CNN1075 is due to the increase in accuratly classifing pions as pions. 
...
\centering
	...
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_stackedevent_0707.png}
	...
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_original_stackedevents_0707.png}
	...
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_trackrange_mupi_acc70_0707.png}
	...
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_original_trackrange_mupi_acc70_0707.png}
...
\centering
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_trackrange_acc75_0707.png}
	...
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_trackrange_acc80_0707.png}
	...
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_trackrange_acc85_0707.png}
	...
	\quad
	\begin{subfigure}[b]{.4\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_trackrange_acc90_0707.png}
...
\centering
	\begin{subfigure}[b]{.45\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_parP_wrongnorm_acc70_0706.png}
	\label{fig:sel1mod_momentum}
	\caption{Momentum distribution of events from Selection I Modified passing CNN with 70\% accuracy}
	\end{subfigure}
	\quad
	\begin{subfigure}[b]{.45\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_parP_stackedevents_0707.png}
	...
	\quad
	\begin{subfigure}[b]{.45\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_original_parP_stackedevents_0707.png}
...
\centering
	\begin{subfigure}[b]{.45\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_cnn_trackrange_mupi_acc70_0707.png}a
	\caption{Stacked signal $\mu$ / backround $\mu and \pi$ track range distribution of CNN @ 70\%}
	\end{subfigure}
	\quad
	\begin{subfigure}[b]{.45\textwidth}
	\includegraphics[width=\textwidth]{figs/sel1mod_mupi_trackrange_acc70.png}
	\caption{Stacked  signal $\mu$ and$ \pi$ / backround $\mu$ and $\pi$  track range distribution of CNN @ 70\%}
	\end{subfigure}
	\quad
...
\centering
	...
	\includegraphics[width=\textwidth]{figs/interesting_event.png}
	\label{fig:longer_muon_badreco}
	\caption{Pion recontructed track range is less than 75 cm and larger than muon reconstructed track because of dead wires through muon track}
	\end{subfigure}
	\quad
	\begin{subfigure}[b]{.3\textwidth}
	\includegraphics[width=\textwidth]{figs/event2.png}
	...
	\includegraphics[width=\textwidth]{figs/mupievent.png}
