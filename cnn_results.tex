\chapter{Results of Convolutional Neural Networks on particles \textcolor{red}{\textbf{WORKING TITLE}}}\label{ch:cnn_results}
...
All future classifications will be done using Selection I Modified CC-Inclusive Filter because it has a higher efficiency and purity than Selection I Original CC-Inclusive Filter.
\subsection{Classification of MC data using Selection I Modified CC-Inclusive Filter}
