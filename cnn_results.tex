...
CNN100000 was trained using 20,000 images of each $\mu/\pi/p/\gamma/e$. For classification of BNB+Cosmics and data, images were made from track candidates that passed the Selection I filter, however, unlike for classifying BNB+Cosmics using CNN10000, the classification of CNN100000 went further up Selection I's cut chain. For CNN100000, steps 1,2,3 and 4 seen in \ref{section:eventselection}. The results of using CNN100000 to classify BNB+Cosmics will be outlined below.
\subsection{Classification of MC data using Selection I CC-Inclusive Filter}
